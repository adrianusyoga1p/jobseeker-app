    ...
    dropdownMenu: {
      ...
      variants: {
        ...
        active: {
          ...
          false: {
            item: [
              "text-netral-100 data-highlighted:text-primary-main data-[state=open]:text-highlighted data-highlighted:before:bg-primary-surface data-[state=open]:before:bg-elevated/50",
              "transition-colors before:transition-colors",
            ],
            itemLeadingIcon: [
      ...
      compoundVariants: [
        {
          ...
          active: false,
          class: {
            item: "text-netral-100 data-highlighted:text-primary-main data-highlighted:before:bg-primary-surface data-[state=open]:before:bg-primary/10",
